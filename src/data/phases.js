export const phases = [
  ...
  },
  {
    id: 'p2', name: 'Data Viz', color: '#00e5a0', days: [
      {
        day: 11, title: 'Task Scheduler Finish + Data Viz Start', tasks: [
      ...
      {
        day: 12, title: 'Pandas Deep Dive', tasks: [
      ...
      {
        day: 13, title: 'Matplotlib + Seaborn', tasks: [
      ...
      {
        day: 14, title: 'Netflix Data Analysis Project', tasks: [
      ...
      {
        day: 15, title: 'Big Banger Visualization Project', tasks: [
  ...
  },
  {
    id: 'p3', name: 'SQL', color: '#ff6b6b', days: [
      {
        day: 16, title: 'SQL — Day 1: Basics', tasks: [
      ...
      {
        day: 17, title: 'SQL — Day 2: Aggregations + Joins', tasks: [
      ...
      {
        day: 18, title: 'SQL — Day 3: Subqueries + Window Functions', tasks: [
      ...
      {
        day: 19, title: 'SQL — Day 4: Advanced SQL', tasks: [
      ...
      {
        day: 20, title: 'SQL — Day 5: Course Projects', tasks: [
      ...
      {
        day: 21, title: 'SQL — Days 6-10 (continue course)', tasks: [
      ...
      {
        day: 30, title: 'SQL Big Banger Project 1: Hospital DB', tasks: [
      ...
      {
        day: 31, title: 'SQL Big Banger Project 2: E-Commerce Analytics', tasks: [
      ...
      {
        day: 32, title: 'SQL Big Banger Project 3 (day 2)', tasks: [
      ...
      {
        day: 33, title: 'SQL with Python (SQLite)', tasks: [
      ...
      {
        day: 34, title: 'Python + SQLite Portfolio Project', tasks: [
      ...
      {
        day: 35, title: 'SQL+Python: Final Portfolio Project', tasks: [
  ...
  },
  {
    id: 'p4', name: 'Math & Stats', color: '#ffd166', days: [
      {
        day: 36, title: 'Math for AI — Week 1: Stats Foundations', tasks: [
      ...
      {
        day: 37, title: 'Central Tendency + Variance + StdDev', tasks: [
      ...
      {
        day: 38, title: 'Probability Basics + Conditional Probability', tasks: [
      ...
      {
        day: 39, title: 'Linear Algebra — Vectors + Matrices', tasks: [
      ...
      {
        day: 40, title: 'Linear Algebra — Eigenvalues + Gradient Descent', tasks: [
      ...
      {
        day: 41, title: 'Math Review + Integration Day', tasks: [
      ...
      {
        day: 42, title: 'Math Week 2: Deep practice + problem sets', tasks: [
  ...
  },
  {
    id: 'p5', name: 'Machine Learning', color: '#06d6a0', days: [
      {
        day: 43, title: 'ML Part 1 — Maths + Foundations', tasks: [
      ...
      {
        day: 44, title: 'ML — Preprocessing + Supervised Learning', tasks: [
      ...
      {
        day: 45, title: 'ML Portfolio Project — Day 1', tasks: [
      ...
      {
        day: 46, title: 'ML Portfolio Project — Day 2', tasks: [
      ...
      {
        day: 47, title: 'ML Portfolio Project — Day 3 (Finish)', tasks: [
      ...
      {
        day: 48, title: 'ML Part 2 — Unsupervised Learning', tasks: [
      ...
      {
        day: 49, title: 'ML Unsupervised Portfolio Project — Day 1', tasks: [
      ...
      {
        day: 50, title: 'ML Unsupervised Portfolio Project — Day 2', tasks: [
      ...
      {
        day: 51, title: 'ML Week — Hybrid Project Day', tasks: [
  ...
  },
  {
    id: 'p6', name: 'FastAPI', color: '#4cc9f0', days: [
      {
        day: 52, title: 'FastAPI — Day 1: Basics', tasks: [
      ...
      {
        day: 53, title: 'FastAPI — Day 2: Routers + SQLModel', tasks: [
      ...
      {
        day: 54, title: 'FastAPI — Day 3: Auth + JWT', tasks: [
      ...
      {
        day: 55, title: 'FastAPI — Day 4: Redis + RBAC + Relationships', tasks: [
      ...
      {
        day: 56, title: 'FastAPI — Day 5: Error Handling + Middleware + Email', tasks: [
      ...
      {
        day: 57, title: 'FastAPI — Day 6: Background Tasks + Testing + Deploy', tasks: [
      ...
      {
        day: 58, title: 'FastAPI Project — Complete Backend App (Day 1)', tasks: [
      ...
      {
        day: 59, title: 'FastAPI Project — Job Board (Day 2)', tasks: [
      ...
      {
        day: 60, title: 'FastAPI Project — Job Board (Day 3 — Polish + Deploy)', tasks: [
      ...
      {
        day: 61, title: 'FastAPI Playlist — Advanced Concepts (9 days start)', tasks: [
      ...
      {
        day: 70, title: 'MEGA Backend Project — Starts (15 days)', tasks: [
      ...
      {
        day: 85, title: 'MEGA Backend Project — MLOps + Deploy', tasks: [
  ...
  },
  {
    id: 'p7', name: 'Deep Learning', color: '#e040fb', days: [
      {
        day: 89, title: 'Deep Learning — Neural Networks Basics', tasks: [
      ...
      {
        day: 100, title: 'Deep Learning Project (3 days — 6h each)', tasks: [
      ...
      {
        day: 101, title: 'DL Project — FastAPI + Frontend', tasks: [
      ...
      {
        day: 102, title: 'DL Project — Add to NeuralHub + Deploy', tasks: [
  ...
  },
  {
    id: 'p8', name: 'NLP', color: '#ffb347', days: [
      {
        day: 103, title: 'NLP — Start Playlist', tasks: [
      ...
      {
        day: 112, title: 'NLP Project 1', tasks: [
      ...
      {
        day: 113, title: 'NLP Project 2', tasks: [
      ...
      {
        day: 114, title: 'NLP GOAT Project (6 days)', tasks: [
  ...
  },
  {
    id: 'p9', name: 'Gen AI', color: '#f72585', days: [
      {
        day: 120, title: 'Gen AI — RAG + LangGraph Crash Course', tasks: [
      ...
      {
        day: 121, title: 'Build RAG+LangGraph Project', tasks: [
      ...
      {
        day: 122, title: 'Practice: Another RAG project (6h)', tasks: [
      ...
      {
        day: 123, title: 'Gen AI Full Course', tasks: [
      ...
      {
        day: 124, title: 'Gen AI Course Day 2 + Projects Start', tasks: [
      ...
      {
        day: 125, title: 'Gen AI MEGA Project (15 days)', tasks: [
  ...
  },
  {
    id: 'p10', name: 'Agentic AI', color: '#00b4d8', days: [
      {
        day: 140, title: 'Agentic AI — Playlist Start', tasks: [
      ...
      {
        day: 149, title: 'Agentic AI MEGA Project (15 days)', tasks: [
  ...
  },
  {
    id: 'p11', name: 'Mega Project', color: '#ffd60a', days: [
      {
        day: 164, title: 'MEGA PROJECT START: IntelliStack AI Platform', tasks: [
      ...
      {
        day: 183, title: 'DONE — Deploy + Launch', tasks: [
